...
public final class RealConnectionPool {
    ...
    while (true) {
      ...
      if (waitNanos > 0) {
        ...
        synchronized (RealConnectionPool.this) {
          try {
            RealConnectionPool.this.wait(waitMillis, (int) waitNanos);//过了时间就干掉，没过就等待
   ...
   */
  boolean transmitterAcquirePooledConnection(Address address, Transmitter transmitter, //transmitter是真正的进行io操作的通道
  ...
  public void connectFailed(Route failedRoute, IOException failure) { //回收
